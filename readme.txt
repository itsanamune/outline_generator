...
Create a Virtual Environment: Before installing dependencies, it's recommended to create a virtual environment to avoid conflicts with other projects.
bashCopy code
python3 -m venv venv
source venv/bin/activate


Install Dependencies: This project requires pandas for data manipulation and Excel file generation.
bashCopy code
pip install pandas
